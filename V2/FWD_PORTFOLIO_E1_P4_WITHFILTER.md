# E1 P4_timeSL_P95 EXPERIMENT — withfilter
...
- **Filter:** LOSERFAC `event_red_and_range_expand` (drop if candle RED & range ≥ 1.5×20-bar ATR).
...
E1 P4_timeSL_P95 EXPERIMENT  Dec 2024 - Apr 2025  [withfilter]
================================================================
...
FILTER  : LOSERFAC event_red_and_range_expand (drop RED & range>=1.5xATR)
...
----------------------------------------------------------------
candidate trades (after filter) : 152
trades taken (opened)           : 93
  of which skipped (max-open)   : 59
closed (TP/timeout/force)       : 93
  wins                          : 79
  losses                        : 14
win rate (of closed)            : 84.9%
avg pnl/trade $                : 0.13
start capital                  : $1000.00
final capital                  : $1012.02
net return                     : 1.20%
================================================================

## Files

- `V2/outputs/fwd_portfolio_e1_p4_withfilter_trades.csv` — every trade.
- `V2/outputs/fwd_portfolio_e1_p4_withfilter_summary.txt` — summary above.
