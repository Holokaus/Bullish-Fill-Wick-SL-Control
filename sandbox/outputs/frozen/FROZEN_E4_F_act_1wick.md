# FROZEN CANDIDATE — E4 F_act_1wick
...
| **Price Stop** | **Breakeven Activation** — if trade reaches MFE ≥ 1.0 wick_gap, move stop to entry + 15 bps |
| **Cost Model** | Flat 15 bps round-trip |

**Spec Hash:** `E4|4h|W3_NODIP|F_act_1wick|TP_1.5x|activation=1.0wg_BE+15bps|K=24|15bps`
...
| n trades | **1,470** |
| Win rate | **84.6%** |
| Net/trade @ 15bps | **+63.6 bps** |
| Monthly net | ~+3,337 bps |
| Max DD (2% stake) | **5.3%** |
